...
s = s.replace("requirements = python3,kivy", "requirements = plyer,libffi,imutils,opencv,numpy,cffi,python3==3.7.9,hostpython3==3.7.9,kivy==master,kivymd==0.104.2,sdl2_ttf==2.0.15,pillow,requests,urllib3,charset-normalizer,idna,moviepy,youtube-dl,imageio,proglog,tqdm,imageio_ffmpeg,ffmpeg")
