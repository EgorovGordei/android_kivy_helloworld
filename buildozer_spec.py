...
s = s.replace("requirements = python3,kivy", "requirements = mdeiapipe,libffi,imutils,opencv,numpy,cffi,python3,kivy==master,kivymd==0.104.2,sdl2_ttf==2.0.15,pillow,requests,urllib3,charset-normalizer,idna,plyer")
