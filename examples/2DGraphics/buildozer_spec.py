...
s = s.replace("requirements = python3,kivy", "requirements = libffi,imutils,cffi,python3==3.7.9,hostpython3==3.7.9,kivy==master,kivymd==0.104.2,sdl2_ttf==2.0.15,urllib3,charset-normalizer,idna")
